      ...
      <nav className="navbar" style={{height:"12px"}}>
        ...
        <div className="row formSignup">
            <form className="row " onSubmit={onFinish}>
              ...
              <div className="col-12">
                ...
                <OverlayTrigger placement="right" overlay={
                    <Tooltip id="tooltip-right" aria-label="warning">
                      ⚠️ Enter your work email not personal e-mail , must contain "@".
                    </Tooltip>
                    }
                  >
              ...
              <div className="col-md-6">
                <label htmlFor="companyType" className="form-label">Company Type <span style={{color:"red"}}>*</span></label>
                <select id="companyType" className="form-select form-control formDiv" style={{height: "29px", fontSize:"12px"}} value={values.companyType} onChange={(e) => setValues({ ...values, companyType: e.target.value })}>
              ...
              <div className="col-12">
                <Link className="already" to="/login">Already have an account ? Login</Link>
              </div>
            </form>
        </div>
