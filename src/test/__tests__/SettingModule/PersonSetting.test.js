...
describe('PersonSetting Component', () => {
  ...
  test('matches the snapshot', async () => {
    const { asFragment, getByText } = render(<PersonSetting />);
  
    // Simulate a button click to set a specific state
    fireEvent.click(getByText(/Profiles/i)); // or any button that sets an active button
