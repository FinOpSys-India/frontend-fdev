...
import MemberCodeVerification from '../../../MemberComponent/CodeVerification/MemberCodeVerification';
...
describe('CodeVerification Component', () => {
  ...
  beforeEach(() => {
    ...
    const routesConfig = [
      {
        path: '/home-member',
        element: <MemberCodeVerification/>,
      },
    ];

    router = createMemoryRouter(routesConfig, {
        initialEntries: ['/home-member'], // Simulate starting at the root
      });
    ...
    fireEvent.click(screen.getByText(/Submit/i));
     ...
     await waitFor(() => {
        expect(axios.post).toHaveBeenCalledWith(
          'http://localhost:9000/login-member',
          { otp: '123456', phoneNumber: '1234567890' },
